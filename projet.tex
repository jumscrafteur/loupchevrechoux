...
Dans cette étude une fois que $P_t = \top$ on considère la suite du chemin comme nulle, on considérera alors pour pouvoir appliquer l'axiome 3 que $\forall t, \neg P_{t-1}$ t apparaissant dans les démonstrations
...
%TODO : Nettoyer un peu l'allure et rajouter des phrases d'explication
